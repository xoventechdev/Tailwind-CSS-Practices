  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-sm mx-auto p-8 bg-white rounded-xl shadow-md space-y-4 sm:flex sm:items-center sm:py-4 sm:space-y-0 sm:space-x-6">
        <img
          className="h-40 mx-auto rounded-full ring-4 ring-gray-300 sm:mx-0 sm:flex-shrink-0"
          src="/hosen.png"
          alt="hosen"
        />
        <div className="text-center space-y-2 sm:text-left">
          ...
          <button className="px-4 py-1 text-sm rounded-full border border-gray-400 text-fuchsia-600">
            Contact
          </button>
        </div>
      </div>
